...
public class Finder {
    ...
    public static int findPoint(Point[] points){
        ...
        String[] methods = getFinalStringPoints();
    ...
    public static int findCircle(Circle[] circles){

        String[] methods = getFinalStringCircles();
        ...
        for(int i = 0;i < circles.length;i++){
            ...
            if(parameters[counter] != null) {
                if (parameters[counter].equals("nome") && circles[i].getName().equals(values[counter])) {
                    fulfilledMethods++;
                }
            }
            counter++;
            if(parameters[counter] != null) {
                if (parameters[counter].equals("x") && (circles[i].getCentralPoint().getX() == Double.parseDouble(values[counter]))) {
                    fulfilledMethods++;
                }
            }
            counter++;
            if(parameters[counter] != null) {
                if (parameters[counter].equals("y") && (circles[i].getCentralPoint().getY() == Double.parseDouble(values[counter]))) {
                    fulfilledMethods++;
                }
            }
            counter++;
            if(parameters[counter] != null){
                if(parameters[counter].equals("raio") && (circles[i].getRadius() == Double.parseDouble(values[counter]))){
                    fulfilledMethods++;
                }
            }
    ...
    public static String[] getFinalStringCircles(){
    ...
    public static String[] getFinalStringPoints(){
